...
export const aiSecurityServices: AISecurityService[] = [
  ...
  },
  {
    ...
    featured: true,
    price: '$997',
    priceNote: 'Launch pricing (limited) • standard $1,997',
  ...
  },
  {
    ...
    priceNote: 'Scoped during discovery • Book a meeting for a quote',
  ...
  },
  {
    ...
    price: 'Custom Engagement',
    priceNote: 'Hardware-dependent • Book a meeting for a quote',
  ...
  },
  {
    ...
    price: 'Custom Engagement',
    priceNote: 'Project-scoped • Book a meeting for a quote',
  ...
  },
  {
    ...
    price: 'Custom Engagement',
    priceNote: 'Environment-dependent • Book a meeting for a quote',
